...
# Clean filter for CSS using CSS Beautify(https://github.com/senchalabs/cssbeautify)
# NOTE: Currently CSS Beautify doesn't support customizing options via command-line arguments, you have to patch the source if you want any customizing
# 林博仁 © 2016

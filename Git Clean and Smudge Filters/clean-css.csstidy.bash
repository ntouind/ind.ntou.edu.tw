...
main() {
	...
	csstidy "$temp_file" --compress_colors=false --compress_font-weight=false --discard_invalid_properties=false --lowercase_s=true --preserve_css=true --remove_bslash=true --merge_selectors=2 --optimise_shorthands=1 --template=low "$temp_file" 1>&2
